...
class PhoneRepositoryTest {
    ...
    void saveAll_manyPhones() {
        final Phone otherPhone = new Phone("Title", 500, 1000.0, "Model", PhoneManufacturer.APPLE);
    ...
    void update_noPhone() {
        target.save(phone);
        final Phone noPhone = new Phone("Title", 500, 1000.0, "Model", PhoneManufacturer.APPLE);
